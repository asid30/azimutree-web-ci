...
<?= $this->section('title') ?>Panduan Azimutree<?= $this->endSection() ?>

<?= $this->section('description') ?>Panduan lengkap penggunaan Azimutree — instruksi fitur, impor/ekspor, dan tips lapangan untuk pengguna Android.<?= $this->endSection() ?>
